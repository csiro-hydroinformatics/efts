...
**efts** is an R package to access EFTS data sets stored in netCDF format. It offers 
convenient functions to access time series, hiding the bug-prone details 
of netCDF array manipulations. 

EFTS netCDF data sets follow the schema described at 
[this location](https://wiki.csiro.au/display/wirada/NetCDF+for+Short-Term+Forecasting) at the time of writing.

The package comes with API documentation, as well as the prevent vignette. You can access both navigating via
...
Perhaps counter to the usual introduction, we will learn to write a EFTS netCDF data set prior to reading it.
